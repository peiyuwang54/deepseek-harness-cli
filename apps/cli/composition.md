...
flowchart LR
  ...
  plugin_dsh_base_command_jobs["command-jobs<br/>@deepseek-ai/dsh-command-jobs"]
  cfg --> plugin_dsh_base_command_jobs
  ...
  plugin_dsh_base_subagent_worktree["subagent-worktree<br/>@deepseek-ai/dsh-subagent-worktree"]
  cfg --> plugin_dsh_base_subagent_worktree
...
| `command-jobs` | `@deepseek-ai/dsh-command-jobs` |
...
| `subagent-worktree` | `@deepseek-ai/dsh-subagent-worktree` |
