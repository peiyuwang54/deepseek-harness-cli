 ...
 * default-terminal diagnostic. The Node compatibility matrix runs this
...
describe('dsh SOURCE launcher (node --import tsx/esm)', () => {
  ...
  it('boots the source entry into the default terminal profile', async () => {
    ...
    expect(result.stderr).toContain('dsh exec')
