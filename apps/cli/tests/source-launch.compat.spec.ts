 ...
 * vector the root `dsh` script invokes directly) and assert that the default
 * terminal profile rejects a pipe with headless guidance. The Node compatibility matrix runs this
...
describe('dsh SOURCE launcher (node --import tsx/esm)', () => {
  ...
  it('boots the default terminal profile and directs pipes to headless', async () => {
