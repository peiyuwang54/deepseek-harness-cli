...
来源：[`packages/mcp/mcp-client/src/index.ts:91`](../packages/mcp/mcp-client/src/index.ts)
...
来源：[`packages/interaction/permission-presets/src/index.ts:151`](../packages/interaction/permission-presets/src/index.ts)
...
来源：[`packages/subagent/subagent-worktree/src/index.ts:27`](../packages/subagent/subagent-worktree/src/index.ts)
...
- `@deepseek-ai/dsh-command-jobs` — 需要 `commands` · `jobs`（[`packages/jobs/command-jobs/src/index.ts`](../packages/jobs/command-jobs/src/index.ts)）
...
- `@deepseek-ai/dsh-mcp`（[`packages/mcp/mcp/src/index.ts`](../packages/mcp/mcp/src/index.ts)）
