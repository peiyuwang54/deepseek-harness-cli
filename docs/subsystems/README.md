...
| [hooks.md](hooks.md) | shared Claude Code / Codex command-hook protocol and the read-only active bridge-configuration catalog |
...
| [mcp.md](mcp.md) | active MCP server status, tool counts, reconnect progress, and immediate reload control |
