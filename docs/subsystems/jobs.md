...
`JobAdoption` transfers hooks for work that already exists. It uses the same preflight as `JobStart`, but contains no starter and therefore cannot create a duplicate operation.
