...
| [`mcp/`](mcp/README.md) | MCP capability family: runtime registry, concrete client, and human diagnostics | Product — stable API |
...
| [`hooks/`](hooks/README.md) | Hook bridges + shared Claude Code / Codex protocol and runtime catalog | Product — stable API |
