...
export const Config: z<Config> = z.object({
  ...
  rewindGitTimeoutMs: z.number().step(1).min(1).default(60_000),
  rewindMaxFileBytes: z.number().step(1).min(1).default(25 * 1024 * 1024),
  rewindMaxTotalBytes: z.number().step(1).min(1).default(200 * 1024 * 1024),
