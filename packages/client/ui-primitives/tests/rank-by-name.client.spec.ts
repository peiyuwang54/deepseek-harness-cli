...
describe('rankByName', () => {
  ...
  it('ranks a prefix above a stronger non-prefix alignment', () => {
  ...
  it('takes the stronger of adjacent and gapped alignments for one character', () => {
    expect(names(rankByName(named('aab', 'ab'), 'ab'))).toEqual(['ab', 'aab'])
  })

  it('keeps item payloads intact', () => {
