...
| [`subagent-worktree/`](subagent-worktree/README.md) | 为隔离的编码子 agent 管理持久化 Git worktree | `ctx.subagentWorktrees` |
...
参见有关[能力家族](../../.agents/notes/implemented/feature/2026-06-21-subagent-capability-seam.md)、[可继续执行的子级](../../.agents/notes/implemented/feature/2026-07-21-continuable-background-subagents.md)、[控制工具](../../.agents/notes/implemented/simplification/2026-07-26-merge-subagent-control-service.md)和[隔离 worktree](../../.agents/notes/implemented/feature/2026-08-18-subagent-worktree-isolation.md)的决策。
