...
export interface TuiCopy {
  ...
  readonly shellModeFooter: string
  readonly shellRunningFooter: string
  readonly shellPromptHelp: string
  readonly shellWaitForTurn: string
  readonly shellAlreadyRunning: string
...
const COPY: Readonly<Record<TuiLocale, TuiCopy>> = {
  en: {
    ...
    shellModeFooter: 'Shell mode · Enter run · Esc clear',
    shellRunningFooter: 'Shell command running · Esc interrupt',
    shellPromptHelp: 'Shell mode: type ! followed by a command, then press Enter.',
    shellWaitForTurn: 'Wait for the active turn to finish before running a shell command.',
    shellAlreadyRunning: 'A shell command is already running.',
    ...
    personalityFriendlyDescription: 'Warm, collaborative, and helpful',
    personalityPragmatic: 'Pragmatic',
    personalityPragmaticDescription: 'Concise, task-focused, and direct',
    current: 'current',
    moveSelectClose: '↑/↓ move • Enter select • Esc close',
    archiveTitle: 'Archive this session?',
    archiveKeep: 'No, keep this session',
    archiveKeepDescription: 'Return to the current conversation',
    archiveConfirm: 'Yes, archive and exit',
    archiveConfirmDescription: 'Hide this session from active lists but retain its log',
    deleteTitle: 'Delete this session?',
    deleteKeep: 'No, keep this session',
    deleteKeepDescription: 'Return to the current conversation',
    deleteConfirm: 'Yes, delete and exit',
    deleteConfirmDescription: 'Permanently remove this session log; this cannot be undone',
  ...
  zh: {
    ...
    shellModeFooter: 'Shell 模式 · Enter 运行 · Esc 清空',
    shellRunningFooter: 'Shell 命令运行中 · Esc 中断',
    shellPromptHelp: 'Shell 模式：输入 ! 和命令，然后按 Enter。',
    shellWaitForTurn: '请等待当前轮次结束后再运行 Shell 命令。',
    shellAlreadyRunning: '已有 Shell 命令正在运行。',
    deepDiving: '正在深度求索',
    ...
    personalityFriendlyDescription: '温暖、协作、乐于帮助',
    personalityPragmatic: '务实',
    personalityPragmaticDescription: '简洁、专注任务、直截了当',
    current: '当前',
    moveSelectClose: '↑/↓ 移动 • Enter 选择 • Esc 关闭',
    archiveTitle: '归档此会话？',
    archiveKeep: '不，保留此会话',
    archiveKeepDescription: '返回当前对话',
    archiveConfirm: '是，归档并退出',
    archiveConfirmDescription: '从活动列表隐藏，但保留完整日志',
    deleteTitle: '删除此会话？',
    deleteKeep: '不，保留此会话',
    deleteKeepDescription: '返回当前对话',
    deleteConfirm: '是，删除并退出',
  ...
  ar: {
    ...
    shellModeFooter: 'وضع الصدفة · Enter تشغيل · Esc مسح',
    shellRunningFooter: 'أمر الصدفة قيد التشغيل · Esc مقاطعة',
    shellPromptHelp: 'وضع الصدفة: اكتب ! ثم أمرًا واضغط Enter.',
    shellWaitForTurn: 'انتظر انتهاء الجولة النشطة قبل تشغيل أمر صدفة.',
    shellAlreadyRunning: 'هناك أمر صدفة قيد التشغيل بالفعل.',
    ...
    personality: 'أسلوب التواصل',
    personalityFriendly: 'ودود',
    personalityFriendlyDescription: 'دافئ ومتعاون ومفيد',
    personalityPragmatic: 'عملي',
    personalityPragmaticDescription: 'موجز ومركز على المهمة ومباشر',
    current: 'الحالي',
    moveSelectClose: '↑/↓ تنقّل • Enter اختيار • Esc إغلاق',
    archiveTitle: 'هل تريد أرشفة هذه الجلسة؟',
    archiveKeep: 'لا، احتفظ بهذه الجلسة',
    archiveKeepDescription: 'العودة إلى المحادثة الحالية',
    archiveConfirm: 'نعم، أرشف واخرج',
    archiveConfirmDescription: 'إخفاؤها من القوائم النشطة مع الاحتفاظ بالسجل',
    deleteTitle: 'هل تريد حذف هذه الجلسة؟',
    deleteKeep: 'لا، احتفظ بهذه الجلسة',
    deleteKeepDescription: 'العودة إلى المحادثة الحالية',
    deleteConfirm: 'نعم، احذف واخرج',
    deleteConfirmDescription: 'حذف سجل هذه الجلسة نهائيًا؛ لا يمكن التراجع',
  ...
  fr: {
    ...
    shellModeFooter: 'Mode shell · Enter exécuter · Esc effacer',
    shellRunningFooter: 'Commande shell en cours · Esc interrompre',
    shellPromptHelp: 'Mode shell : tapez ! suivi d’une commande, puis appuyez sur Enter.',
    shellWaitForTurn: 'Attendez la fin du tour actif avant d’exécuter une commande shell.',
    shellAlreadyRunning: 'Une commande shell est déjà en cours.',
    ...
    personalityFriendly: 'Amical',
    personalityFriendlyDescription: 'Chaleureux, collaboratif et serviable',
    personalityPragmatic: 'Pragmatique',
    personalityPragmaticDescription: 'Concis, centré sur la tâche et direct',
    current: 'actuel',
    moveSelectClose: '↑/↓ déplacer • Enter sélectionner • Esc fermer',
    archiveTitle: 'Archiver cette session ?',
    archiveKeep: 'Non, conserver cette session',
    archiveKeepDescription: 'Revenir à la conversation actuelle',
    archiveConfirm: 'Oui, archiver et quitter',
    archiveConfirmDescription: 'Masquer des listes actives tout en conservant le journal',
    deleteTitle: 'Supprimer cette session ?',
    deleteKeep: 'Non, conserver cette session',
    deleteKeepDescription: 'Revenir à la conversation actuelle',
    deleteConfirm: 'Oui, supprimer et quitter',
    deleteConfirmDescription: 'Supprimer définitivement ce journal ; action irréversible',
  ...
  ru: {
    ...
    shellModeFooter: 'Режим shell · Enter выполнить · Esc очистить',
    shellRunningFooter: 'Команда shell выполняется · Esc прервать',
    shellPromptHelp: 'Режим shell: введите ! и команду, затем нажмите Enter.',
    shellWaitForTurn: 'Дождитесь завершения активного хода перед запуском команды shell.',
    shellAlreadyRunning: 'Команда shell уже выполняется.',
    ...
    personalityFriendly: 'Дружелюбный',
    personalityFriendlyDescription: 'Тёплый, готовый к сотрудничеству и помощи',
    personalityPragmatic: 'Практичный',
    personalityPragmaticDescription: 'Краткий, ориентированный на задачу и прямой',
    current: 'текущий',
    moveSelectClose: '↑/↓ перемещение • Enter выбор • Esc закрыть',
    archiveTitle: 'Архивировать этот сеанс?',
    archiveKeep: 'Нет, оставить этот сеанс',
    archiveKeepDescription: 'Вернуться к текущему разговору',
    archiveConfirm: 'Да, архивировать и выйти',
    archiveConfirmDescription: 'Скрыть из активных списков, сохранив журнал',
    deleteTitle: 'Удалить этот сеанс?',
    deleteKeep: 'Нет, оставить этот сеанс',
    deleteKeepDescription: 'Вернуться к текущему разговору',
    deleteConfirm: 'Да, удалить и выйти',
    deleteConfirmDescription: 'Навсегда удалить журнал; отменить это действие нельзя',
  ...
  es: {
    ...
    shellModeFooter: 'Modo shell · Enter ejecutar · Esc limpiar',
    shellRunningFooter: 'Comando shell en ejecución · Esc interrumpir',
    shellPromptHelp: 'Modo shell: escribe ! seguido de un comando y pulsa Enter.',
    shellWaitForTurn: 'Espera a que termine el turno activo antes de ejecutar un comando shell.',
    shellAlreadyRunning: 'Ya hay un comando shell en ejecución.',
    ...
    personality: 'Estilo de comunicación',
    personalityFriendly: 'Amable',
    personalityFriendlyDescription: 'Cálido, colaborativo y servicial',
    personalityPragmatic: 'Pragmático',
    personalityPragmaticDescription: 'Conciso, centrado en la tarea y directo',
    current: 'actual',
    moveSelectClose: '↑/↓ mover • Enter seleccionar • Esc cerrar',
    archiveTitle: '¿Archivar esta sesión?',
    archiveKeep: 'No, conservar esta sesión',
    archiveKeepDescription: 'Volver a la conversación actual',
    archiveConfirm: 'Sí, archivar y salir',
    archiveConfirmDescription: 'Ocultarla de las listas activas y conservar el registro',
    deleteTitle: '¿Eliminar esta sesión?',
    deleteKeep: 'No, conservar esta sesión',
    deleteKeepDescription: 'Volver a la conversación actual',
    deleteConfirm: 'Sí, eliminar y salir',
    deleteConfirmDescription: 'Eliminar el registro para siempre; no se puede deshacer',
  ...
  ja: {
    ...
    shellModeFooter: 'シェルモード · Enter 実行 · Esc クリア',
    shellRunningFooter: 'シェルコマンドを実行中 · Esc 中断',
    shellPromptHelp: 'シェルモード：! に続けてコマンドを入力し、Enter を押してください。',
    shellWaitForTurn: 'シェルコマンドを実行する前に、現在のターンが完了するまでお待ちください。',
    shellAlreadyRunning: 'シェルコマンドはすでに実行中です。',
    deepDiving: '深く探索中',
    ...
    personality: 'コミュニケーションスタイル',
    personalityFriendly: 'フレンドリー',
    personalityFriendlyDescription: '温かく、協力的で、親切',
    personalityPragmatic: '実務的',
    personalityPragmaticDescription: '簡潔で、タスクに集中し、率直',
    current: '現在',
    moveSelectClose: '↑/↓ 移動 • Enter 選択 • Esc 閉じる',
    archiveTitle: 'このセッションをアーカイブしますか？',
    archiveKeep: 'いいえ、このセッションを残す',
    archiveKeepDescription: '現在の会話に戻る',
    archiveConfirm: 'はい、アーカイブして終了',
    archiveConfirmDescription: 'アクティブ一覧から隠し、ログは保持',
    deleteTitle: 'このセッションを削除しますか？',
    deleteKeep: 'いいえ、このセッションを残す',
    deleteKeepDescription: '現在の会話に戻る',
    deleteConfirm: 'はい、削除して終了',
    deleteConfirmDescription: 'ログを完全に削除します。この操作は元に戻せません',
  ...
  ko: {
    ...
    shellModeFooter: '셸 모드 · Enter 실행 · Esc 지우기',
    shellRunningFooter: '셸 명령 실행 중 · Esc 중단',
    shellPromptHelp: '셸 모드: ! 다음에 명령어를 입력하고 Enter를 누르세요.',
    shellWaitForTurn: '셸 명령을 실행하기 전에 현재 턴이 끝날 때까지 기다리세요.',
    shellAlreadyRunning: '셸 명령이 이미 실행 중입니다.',
    deepDiving: '심층 탐색 중',
    ...
    personality: '소통 방식',
    personalityFriendly: '친근함',
    personalityFriendlyDescription: '따뜻하고 협력적이며 도움을 줌',
    personalityPragmatic: '실용적',
    personalityPragmaticDescription: '간결하고 작업에 집중하며 직접적임',
    current: '현재',
    moveSelectClose: '↑/↓ 이동 • Enter 선택 • Esc 닫기',
    archiveTitle: '이 세션을 보관할까요?',
    archiveKeep: '아니요, 이 세션 유지',
    archiveKeepDescription: '현재 대화로 돌아가기',
    archiveConfirm: '예, 보관 후 종료',
    archiveConfirmDescription: '활성 목록에서 숨기고 기록은 유지',
    deleteTitle: '이 세션을 삭제할까요?',
    deleteKeep: '아니요, 이 세션 유지',
    deleteKeepDescription: '현재 대화로 돌아가기',
    deleteConfirm: '예, 삭제 후 종료',
    deleteConfirmDescription: '세션 기록을 영구 삭제합니다. 되돌릴 수 없습니다',
