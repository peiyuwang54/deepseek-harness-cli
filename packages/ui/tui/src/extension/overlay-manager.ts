...
type TuiOverlayPlacement = 'overlay' | 'inline' | 'composer'
...
export class TuiOverlayManager {
   ...
   * @param placement - terminal overlay for extensions, inline for questions, or composer-attached for built-in pickers.
