...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  tools: 'tools.md',
  tui: 'terminal.md',
  tuiPrompt: 'terminal.md',
  tuiStartup: 'terminal.md',
  typert: 'typert.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  HookCatalogRegistration: 'hooks.md',
  HookCatalogSnapshot: 'hooks.md',
  McpConnectionStatus: 'mcp.md',
  McpReloadResult: 'mcp.md',
  McpResourceContent: 'mcp.md',
  McpServerRuntime: 'mcp.md',
  McpServerResourceCatalog: 'mcp.md',
  McpServerPromptCatalog: 'mcp.md',
  McpServerStatus: 'mcp.md',
  McpPromptExpansion: 'mcp.md',
  ...
  TuiOverlayRequest: 'terminal.md',
  TuiOverlaySession: 'terminal.md',
  TuiPromptUnsubscribe: 'terminal.md',
  TuiPromptValueHandle: 'terminal.md',
  ...
  SubagentWorktreeCreateRequest: 'subagent.md',
  SubagentWorktreeRecord: 'subagent.md',
  SubagentWorktreeMode: 'subagent.md',
