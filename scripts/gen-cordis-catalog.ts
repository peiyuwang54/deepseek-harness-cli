...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  appInterrupt: 'not a service: launcher-provided app interrupt handoff and escalation callback — packages/boot/cmdline/README.md owns the launcher contract',
