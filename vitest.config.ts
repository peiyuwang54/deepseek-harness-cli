  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        // Interactive application paths retain branches that require a real
        // terminal, process composition, or browser lifecycle. Their focused
        // unit tests still run here; assembled snapshot gates own the remaining
        // behavior until browserless coverage harnesses can execute it.
        // TODO(test-coverage): remove each entry when its package lane reaches 100%.
        'packages/boot/app-boot/src/index.ts',
        'packages/bundle/headless/src/exec-events.ts',
        'packages/bundle/headless/src/index.ts',
        'packages/bundle/headless/src/startup.ts',
        'packages/bundle/tui/src/index.ts',
        'packages/bundle/tui/src/startup.ts',
        ...
        'packages/ui/tui/src/chat/approvals.ts',
        'packages/ui/tui/src/chat/autocomplete.ts',
        'packages/ui/tui/src/chat/background-turn.ts',
        'packages/ui/tui/src/chat/credentials.ts',
        'packages/ui/tui/src/chat/external-import.ts',
        'packages/ui/tui/src/chat/goal-status.ts',
        'packages/ui/tui/src/chat/helpers.ts',
        'packages/ui/tui/src/chat/hooks-command.ts',
        'packages/ui/tui/src/chat/ide-bridge.ts',
        'packages/ui/tui/src/chat/image-attachments.ts',
        'packages/ui/tui/src/chat/language.ts',
        'packages/ui/tui/src/chat/mcp-command.ts',
        'packages/ui/tui/src/chat/mcp-tools.ts',
        'packages/ui/tui/src/chat/model-command.ts',
        'packages/ui/tui/src/chat/plugins-command.ts',
        'packages/ui/tui/src/chat/resume.ts',
        'packages/ui/tui/src/chat/rewind.ts',
        'packages/ui/tui/src/chat/settings.ts',
        'packages/ui/tui/src/chat/side.ts',
        'packages/ui/tui/src/chat/stats.ts',
        'packages/ui/tui/src/chat/terminal-mode.ts',
        'packages/ui/tui/src/chat/timing.ts',
        'packages/ui/tui/src/chat/workspace.ts',
        'packages/ui/tui/src/components/dialogs.ts',
        'packages/ui/tui/src/components/theme.ts',
        'packages/ui/tui/src/components/transcript-viewport.ts',
